...
export const metadata: Metadata = {
  title: "PropTrackr — Your home search, structured and clear",
  description:
    "Save listings, plan inspections, and compare properties in one workspace for Australian buyers.",
};
  ...
  return (
    ...
    >
      ...
      <header className="relative z-20 border-b border-[#E5E7EB] bg-white shadow-sm">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-2 sm:gap-3" aria-label="Marketing">
            ...
            <Button
              className="bg-[#0D9488] px-4 font-medium text-white shadow-sm hover:bg-[#0D9488]/90"
              asChild
            >
      ...
      <main className="relative z-10 flex-1">
        ...
        <section className="mx-auto max-w-6xl px-6 pb-16 pt-12 lg:pb-24 lg:pt-16">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="order-2 text-center lg:order-1 lg:text-left">
              ...
              <h1 className="text-balance text-4xl font-semibold leading-[1.12] tracking-tight text-[#111827] sm:text-5xl lg:text-[3.15rem]">
                Your home search,{" "}
                <span className="text-[#0D9488]">structured and clear</span>
              </h1>
              <p className="mx-auto mt-6 max-w-xl text-pretty text-lg leading-relaxed text-[#6B7280] lg:mx-0">
                ...
                keep notes and comparisons in one calm, professional workspace
                — free to start.
              </p>
              <div className="mt-10 flex flex-col items-stretch gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center lg:justify-start">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="h-12 min-w-[160px] border-[#E5E7EB] bg-white text-base font-medium text-[#111827] hover:bg-[#F8F9FA]"
                  asChild
                >
                  <Link href="/sign-in">Sign in</Link>
                </Button>
            ...
            <div className="order-1 mx-auto w-full max-w-md lg:order-2 lg:max-w-none">
              <div className="rounded-2xl border border-[#E5E7EB] bg-white p-4 shadow-md lg:p-6">
                <HeroIllustration className="h-auto w-full max-h-[420px]" />
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Feature tiles */}
        <section
          className="border-t border-[#E5E7EB] bg-white py-16 lg:py-24"
        ...
        >
          <div className="mx-auto max-w-6xl px-6">
            ...
            <ul className="mt-12 grid gap-6 sm:grid-cols-3 sm:gap-8 lg:mt-16">
              {features.map(({ title, description, icon: Icon }) => (
                <li
                  key={title}
                  className="rounded-xl border border-[#E5E7EB] bg-[#F8F9FA] p-8 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
                  style={{ backgroundColor: "#F8F9FA" }}
                >
      ...
      <footer className="relative z-10 border-t border-[#E5E7EB] bg-white">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 sm:flex-row sm:items-center sm:justify-between lg:py-12">
          <div>
            <p className="font-semibold text-[#111827]">PropTrackr</p>
            <p className="mt-1 max-w-sm text-sm text-[#6B7280]">
              A premium workspace for serious property buyers in Australia.
            </p>
          </div>
